...
Обидва набори покривають те саме. Обидва мають префікс, щоб не конфліктувати з нічим іншим, що
ви встановили; різниться лише роздільник: Claude Code відокремлює простір імен плагіна двокрапкою,
а в Antigravity простору імен немає, тож префікс є частиною назви:
